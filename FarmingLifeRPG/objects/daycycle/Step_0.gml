...
if(drawMinutes < 10) drawZero = "0"
else drawZero = -1;

switch(season){
	case 1: drawSeason = "Spring"; break;
	case 2: drawSeason = "Summer"; break;
	case 3: drawSeason = "Autumn"; break;
	case 4: drawSeason = "Winter"; break;
}