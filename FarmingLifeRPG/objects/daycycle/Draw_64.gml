...
draw_text_color(10, 10, string(floor(hours))+string(":")+string(floor(drawMinutes)), ct,ct,ct,ct, 1);

draw_text_color(10, 50, string("Day:"), ct,ct,ct,ct, 1);
draw_text_color(55, 50, string(day), ct,ct,ct,ct, 1);

draw_text_color(10, 70, string("Season:"), ct,ct,ct,ct, 1);
draw_text_color(85, 70, string(season), ct,ct,ct,ct, 1);
